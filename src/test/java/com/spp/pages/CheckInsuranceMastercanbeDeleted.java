...
public class CheckInsuranceMastercanbeDeleted extends BasePage{
	@FindBy(id="master")
	...
	@FindBy(xpath="//*[@id=\"standing_instr_list\"]/div/table/tbody/tr[1]/td[3]/a")
	...
	@FindBy(xpath="//*[@id=\"standing_instr_list\"]/div/table/tbody/tr[1]/td[4]/a")
	WebElement DeleteInsurance;
	@FindBy(xpath="//strong[text()='Insurance successfully deleted']")
	WebElement successfulmessage;
	
	public CheckInsuranceMastercanbeDeleted(WebDriver driver) {
		super(driver);
