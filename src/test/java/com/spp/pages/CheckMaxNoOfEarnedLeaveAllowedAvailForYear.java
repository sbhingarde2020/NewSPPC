...
public class CheckMaxNoOfEarnedLeaveAllowedAvailForYear extends BasePage{
	@FindBy(id="master")
	WebElement masterLink;
	@FindBy(xpath="//*[@id=\"menu\"]/li[3]/div/div[3]/ul/li[2]/a")
	WebElement leavePolicy;
    @FindBy(xpath="//*[@id='leave-policy-master-list']/table/tbody/tr[4]/td[4]/a")
	...
	WebElement Message2;
	@FindBy(xpath="//*[@id=\"apply_leave_response\"]/div/strong")
	WebElement LeaveHistoryTab;
	@FindBy(xpath="//*[@id=\"leave_detail_for_employee\"]/table/tbody/tr[1]/td[4]/a")
	WebElement View1;
	@FindBy(xpath="//*[@id=\"batch_details\"]/form/table[3]/tbody/tr[2]/td/input[3]")
	WebElement Delete;
	
	public CheckMaxNoOfEarnedLeaveAllowedAvailForYear(WebDriver driver) {
		super(driver);
	...
	public void clickAvailForYear(String value){
		AvailForYear.clear();
		AvailForYear.sendKeys(value);
	}
	...
	public void selectLeaveHistoryTab(){
		LeaveHistoryTab.click();
	}
