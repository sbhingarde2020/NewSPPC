...
public class LockPaymonth extends BasePage{
	@FindBy(id="salary")
	WebElement SalaryLink;
	@FindBy(xpath="//*[@id=\"menu\"]/li[6]/div/div[1]/ul/li[1]/a")
	WebElement PaymonthsLink;
	@FindBy(xpath="//*[@id=\"paymonth-lists\"]/form/div[3]/table/tbody/tr[2]/td[5]/input")
	WebElement LockMonth;
	...
	public LockPaymonth(WebDriver driver) {
		super(driver);
