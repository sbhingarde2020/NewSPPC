...
public class GenerateReportWriterGroupByPaymonthandDepartmentandDesignation extends BasePage{
	@FindBy(id="report")
	WebElement Report;
	...
	public GenerateReportWriterGroupByPaymonthandDepartmentandDesignation(WebDriver driver) {
		super(driver);
