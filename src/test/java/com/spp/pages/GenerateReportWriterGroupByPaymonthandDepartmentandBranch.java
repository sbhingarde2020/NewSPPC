...
public class GenerateReportWriterGroupByPaymonthandDepartmentandBranch extends BasePage{
	@FindBy(id="report")
	WebElement Report;
	...
	@FindBy(xpath="//*[@id='content_wrapper']/table/tbody/tr/td[normalize-space()='Branch']/parent::tr/td/input")
	WebElement ClassificationDetailBranch;
	...
	public GenerateReportWriterGroupByPaymonthandDepartmentandBranch(WebDriver driver) {
		super(driver);
	...
	public void clickBranchCheckbox() {
		ClassificationDetailBranch.click();
	}
