...
public class GetFinancialListAccordingToAllFinancialInstituions extends BasePage {
	@FindBy(id="master")
	...
	public GetFinancialListAccordingToAllFinancialInstituions(WebDriver driver) {
		super(driver);
