...
public class GenerateReportWriterGroupByPaymonthandDepartmentandAttendance extends BasePage{
	@FindBy(id="report")
	WebElement Report;
	...
	@FindBy(xpath="//*[@id='content_wrapper']/table/tbody/tr/td[normalize-space()='Attendance']/parent::tr/td/input")
	WebElement ClassificationDetailAttendance;
	...
	public GenerateReportWriterGroupByPaymonthandDepartmentandAttendance(WebDriver driver) {
		super(driver);
	...
	public void clickAttendanceCheckbox() {
		ClassificationDetailAttendance.click();
	}
