...
public class GenerateReportWriterGroupByPaymonthandDepartmentandSalStructure extends BasePage{
	@FindBy(id="report")
	WebElement Report;
	...
	@FindBy(xpath="//*[@id='content_wrapper']/table/tbody/tr/td[normalize-space()='Sal Structure']/parent::tr/td/input")
	WebElement ClassificationDetailSalStructure;
	...
	public GenerateReportWriterGroupByPaymonthandDepartmentandSalStructure(WebDriver driver) {
		super(driver);
	...
	public void clickSalStructureCheckbox() {
		ClassificationDetailSalStructure.click();
	}
