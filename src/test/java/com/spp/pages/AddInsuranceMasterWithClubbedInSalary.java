...
public class AddInsuranceMasterWithClubbedInSalary extends BasePage{
	@FindBy(id="master")
	...
	@FindBy(linkText="Add New Insurance Master")
	...
	public AddInsuranceMasterWithClubbedInSalary(WebDriver driver){
		super(driver);
