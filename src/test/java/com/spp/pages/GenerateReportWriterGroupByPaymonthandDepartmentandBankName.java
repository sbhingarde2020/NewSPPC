...
public class GenerateReportWriterGroupByPaymonthandDepartmentandBankName extends BasePage{
	@FindBy(id="report")
	WebElement Report;
	...
	@FindBy(xpath="//*[@id='content_wrapper']/table/tbody/tr/td[normalize-space()='Bank Name']/parent::tr/td/input")
	WebElement ClassificationDetailBankName;
	...
	public GenerateReportWriterGroupByPaymonthandDepartmentandBankName(WebDriver driver) {
		super(driver);
	...
	public void clickBankNameCheckbox() {
		ClassificationDetailBankName.click();
	}
